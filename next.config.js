...
const securityHeaders = [
  ...
  },
  {
    ...
    value: `upgrade-insecure-requests; object-src 'none'; frame-ancestors 'none'; form-action 'none'; font-src https://fonts.googleapis.com https://fonts.gstatic.com 'self' data:; script-src 'self' 'nonce-eXFBngjwfBsaKvk2tWSS' blob: ${
      isLocal ? "'unsafe-eval'" : ''
